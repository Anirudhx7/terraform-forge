...
### Infracost GitHub Actions integration
...
Tag test resources for automated TTL-based cleanup:
...
Use a scheduled Lambda or CI job to sweep resources past their TTL.
